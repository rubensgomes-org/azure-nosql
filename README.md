...
Spring Boot demo integrating Azure Cosmos DB (NoSQL API).

This is a **scaffold**. The build, CI, release, and container machinery are
complete and green; the Azure Cosmos DB integration itself is not wired up yet — see
...
```bash
git clone https://github.com/rubensgomes-org/azure-nosql.git
cd azure-nosql
```
...
└── app/
    ...
    └── src/
        ...
        ├── main/java/com/rubensgomes/azure/nosql/
